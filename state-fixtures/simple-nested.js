module.exports = {
  viewState: {
    runTime: 330762,
    isPlaying: false,
    currentTime: 135077.65508982036,
    zoom: 1,
    x: 0,
    isImportOpen: false,
  ...
  range: {
    ...
    list: {
      ...
      'id-1548164246675': {
        startTime: 117252.15808383234,
        endTime: 135077.65508982036,
        label: 'Untitled range',
        summary: '',
        colour: null,
        depth: 1,
    ...
    undoQueue: [
      {
        action: {
          type: 'MOVE_POINT',
          payload: {
            x: 117252.15808383234,
            originalX: 123788.17365269462,
          },
        },
      },
    ],
